...
export const copyEs: Copy = {
  ...
  audit: {
    ...
    filterActor: 'Autor',
    filterCorrelation: 'Correlación',
    filterFrom: 'Desde',
    filterTo: 'Hasta',
    filterAll: 'Cualquiera',
    actorPlaceholder: 'Correo exacto',
    correlationPlaceholder: 'Identificador exacto',
    ...
    none: 'Todavía no se ha registrado nada.',
    ...
    viewOperation: 'Ver todos los registros de esta operación',
    detailChanges: 'Qué cambió',
    detailField: 'Campo',
    detailBefore: 'Antes',
    detailAfter: 'Después',
    detailNoChanges: 'Este registro anota un suceso sin cambios de campos.',
    detailPermission: 'Permiso',
    detailUserAgent: 'Navegador',
    noActor: 'Nadie con sesión',
    noPermission: 'No requiere',
    emptyValue: 'Ninguno',
    valueTrue: 'Sí',
    valueFalse: 'No',
    appendOnly:
  ...
  auditActions: {
    ...
    'organization.updated': 'Empresa editada',
    'organization.activated': 'Empresa activada',
    'organization.deactivated': 'Empresa desactivada',
    'organization.deleted': 'Empresa eliminada',
    ...
    'platform_admin.granted': 'Acceso de plataforma concedido',
    'platform_admin.revoked': 'Acceso de plataforma retirado',
