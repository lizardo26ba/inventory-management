...
/**
 * La pantalla lee la dirección para saber qué filtrar, desde qué fila mostrar y
 * qué registro abrir, así que necesita una frontera de suspensión por encima. El
...
export default function AuditPage(): React.ReactElement {
  return (
    <Suspense fallback={<ListPageSkeleton columns={5} summaryCards={0} />}>
